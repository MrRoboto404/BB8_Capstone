...
p.m_body = 3;    %kg, Mass of the body
...
p.l = 0.132;     %m, Height of the center of gravity of body from center of ball
...
p.Theta_motor_rotor = 6.33 * 10^-6; % rotor intertia (real small)
